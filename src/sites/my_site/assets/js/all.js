...
Sizzle.error = function( msg ) {
	try {throw new Error( "Syntax error, unrecognized expression: " + msg );} catch (e) {}
};
...
$.widget( "ui.autocomplete", {
	...
	_suggest: function( items ) {
		...
		// Add the tail
		ul.prepend('<span class="tail"></span>');
...
})}function an(){var aJ,aI,aL,aK,aM,s=false;al.unbind("touchstart.jsp touchmove.jsp touchend.jsp click.jsp-touchclick").bind("touchstart.jsp",function(aN){var aO=aN.originalEvent.touches[0];aJ=aC();aI=aA();aL=aO.pageX;aK=aO.pageY;aM=false;s=true}).bind("touchmove.jsp",function(aQ){if(!s){return}var aP=aQ.originalEvent.touches[0],aO=aa,aN=I;Q.scrollTo(aJ+aL-aP.pageX,aI+aK-aP.pageY);aM=aM||Math.abs(aL-aP.pageX)>5||Math.abs(aK-aP.pageY)>5;return aO==aa&&aN==I}).bind("touchend.jsp",function(aN){s=false}).bind("click.jsp-touchclick",function(aN){if(aM){aM=false;return false}})}function g(){var s=aA(),aI=aC();D.removeClass("jspScrollable").unbind(".jsp");D.replaceWith(ao.append(Y.children()));ao.scrollTop(s);ao.scrollLeft(aI);if(av){clearInterval(av)}}b.extend(Q,{reinitialise:function(aI){aI=b.extend({},ay,aI);ar(aI)},scrollToElement:function(aJ,aI,s){ab(aJ,aI,s)},scrollTo:function(aJ,s,aI){N(aJ,aI);M(s,aI)},scrollToX:function(aI,s){N(aI,s)},scrollToY:function(s,aI){M(s,aI)},scrollToPercentX:function(aI,s){N(aI*(T-aj),s)},scrollToPercentY:function(aI,s){M(aI*(Z-v),s)},scrollBy:function(aI,s,aJ){Q.scrollByX(aI,aJ);Q.scrollByY(s,aJ)},scrollByX:function(s,aJ){var aI=aC()+Math[s<0?"floor":"ceil"](s),aK=aI/(T-aj);W(aK*j,aJ)},scrollByY:function(s,aJ){var aI=aA()+Math[s<0?"floor":"ceil"](s),aK=aI/(Z-v);V(aK*i,aJ)},positionDragX:function(s,aI){W(s,aI)},positionDragY:function(aI,s){V(aI,s)},animate:function(aI,aL,s,aK){var aJ={};aJ[aL]=s;aI.animate(aJ,{duration:ay.animateDuration,easing:ay.animateEase,queue:false,step:aK})},getContentPositionX:function(){return aC()},getContentPositionY:function(){return aA()},getContentWidth:function(){return T},getContentHeight:function(){return Z},getPercentScrolledX:function(){return aC()/(T-aj)},getPercentScrolledY:function(){return aA()/(Z-v)},getIsScrollableH:function(){return aE},getIsScrollableV:function(){return az},getContentPane:function(){return Y},scrollToBottom:function(s){V(i,s)},hijackInternalLinks:b.noop,destroy:function(){g()}});ar(O)}e=b.extend({},b.fn.jScrollPane.defaults,e);b.each(["mouseWheelSpeed","arrowButtonSpeed","trackClickSpeed","keyboardSpeed"],function(){e[this]=e[this]||e.speed});return this.each(function(){var f=b(this),g=f.data("jsp");if(g){g.reinitialise(e)}else{g=new d(f,e);f.data("jsp",g)}})};b.fn.jScrollPane.defaults={showArrows:false,maintainPosition:true,stickToBottom:false,stickToRight:false,clickOnTrack:true,autoReinitialise:false,autoReinitialiseDelay:500,verticalDragMinHeight:0,verticalDragMaxHeight:99999,horizontalDragMinWidth:0,horizontalDragMaxWidth:99999,contentWidth:c,animateScroll:false,animateDuration:300,animateEase:"linear",hijackInternalLinks:false,verticalGutter:4,horizontalGutter:4,mouseWheelSpeed:0,arrowButtonSpeed:0,arrowRepeatFreq:50,arrowScrollOnHover:false,trackClickSpeed:0,trackClickRepeatFreq:70,verticalArrowPositions:"split",horizontalArrowPositions:"split",enableKeyboardNavigation:true,hideFocus:false,keyboardSpeed:0,initialDelay:300,speed:30,scrollPagePercent:0.8}})(jQuery,this);function MarkerClusterer(a,b,c){this.extend(MarkerClusterer,google.maps.OverlayView);this.map_=a;this.markers_=[];this.clusters_=[];this.sizes=[31,58,102];this.styles_=[];this.ready_=!1;c=c||{};this.gridSize_=c.gridSize||60;this.minClusterSize_=c.minimumClusterSize||2;this.maxZoom_=c.maxZoom||null;this.styles_=c.styles||[];this.imagePath_=c.imagePath||this.MARKER_CLUSTER_IMAGE_PATH_;this.imageExtension_=c.imageExtension||this.MARKER_CLUSTER_IMAGE_EXTENSION_;this.zoomOnClick_=!0;void 0!=c.zoomOnClick&&
...
MarkerClusterer.prototype.MARKER_CLUSTER_IMAGE_PATH_="/assets/img/map/cluster";MarkerClusterer.prototype.MARKER_CLUSTER_IMAGE_EXTENSION_="png";MarkerClusterer.prototype.extend=function(a,b){return function(a){for(var b in a.prototype)this.prototype[b]=a.prototype[b];return this}.apply(a,[b])};MarkerClusterer.prototype.onAdd=function(){this.setReady_(!0)};MarkerClusterer.prototype.draw=function(){};
...
ClusterIcon.prototype.setSums=function(a){this.sums_=a;this.text_=a.text;this.index_=a.index;this.div_&&(this.div_.innerHTML=a.text);this.useStyle()};ClusterIcon.prototype.useStyle=function(){var a=Math.max(0,this.sums_.index-1),a=Math.min(this.styles_.length-1,a),b=this.styles_[a];this.url_=b.url;this.height_=b.height;this.width_=b.width;this.textColor_="white";this.anchor_=b.anchor;this.textSize_=b.textSize;2==a&&(this.textSize_=41);1==a&&(this.textSize_=21);this.backgroundPosition_=b.backgroundPosition};
...
(function(c){c.fn.slides=function(a){a=c.extend({},c.fn.slides.option,a);return this.each(function(){function j(s,f,j){if(!p&&u){p=!0;a.animationStart(h+1);switch(s){case "next":k=h;e=h+1;e=g===e?0:e;s=2*-v;h=e;break;case "prev":k=h;e=h-1;e=-1===e?g-1:e;s=0;h=e;break;case "pagination":e=parseInt(j,10),k=c("."+a.paginationClass+" li."+a.currentClass+" a",b).attr("href").match("[^#/]+$"),s=e>k?2*-v:0,h=e}"fade"===f?a.crossfade?d.children(":eq("+e+")",b).css({zIndex:10}).fadeIn(a.fadeSpeed,a.fadeEasing,
function(){a.autoHeight?d.animate({height:d.children(":eq("+e+")",b).outerHeight()},a.autoHeightSpeed,function(){d.children(":eq("+k+")",b).css({display:"none",zIndex:0});d.children(":eq("+e+")",b).css({zIndex:0});a.animationComplete(e+1);p=!1}):(d.children(":eq("+k+")",b).css({display:"none",zIndex:0}),d.children(":eq("+e+")",b).css({zIndex:0}),a.animationComplete(e+1),p=!1)}):d.children(":eq("+k+")",b).fadeOut(a.fadeSpeed,a.fadeEasing,function(){a.autoHeight?d.animate({height:d.children(":eq("+
e+")",b).outerHeight()},a.autoHeightSpeed,function(){d.children(":eq("+e+")",b).fadeIn(a.fadeSpeed,a.fadeEasing)}):d.children(":eq("+e+")",b).fadeIn(a.fadeSpeed,a.fadeEasing,function(){c.browser.msie&&c(this).get(0).style.removeAttribute("filter")});a.animationComplete(e+1);p=!1}):(d.children(":eq("+e+")").css({display:"block"}),a.autoHeight?d.animate({height:d.children(":eq("+e+")").outerHeight()},a.slideSpeed,a.slideEasing,function(){d.children(":eq("+e+")").css({zIndex:5});d.children(":eq("+k+
")").css({display:"none",zIndex:0});a.animationComplete(e+1);p=!1}):d.animate({},a.slideSpeed,a.slideEasing,function(){d.children(":eq("+e+")").css({zIndex:5});d.children(":eq("+k+")").css({display:"none",zIndex:0});a.animationComplete(e+1);p=!1}));a.pagination&&(c("."+a.paginationClass+" li."+a.currentClass,b).removeClass(a.currentClass),c("."+a.paginationClass+" li:eq("+e+")",b).addClass(a.currentClass))}}function l(){a.pause?(clearTimeout(b.data("pause")),clearInterval(b.data("interval")),w=setTimeout(function(){clearTimeout(b.data("pause"));
t=setInterval(function(){j("next",n)},a.play);b.data("interval",t)},a.pause),b.data("pause",w)):clearInterval(b.data("interval"))}c("."+a.container,c(this)).children().wrapAll('<div class="slides_control"/>');var b=c(this),d=c(".slides_control",b),g=d.children().size(),v="100%",q=d.children().outerHeight(),f=a.start-1,n=0>a.effect.indexOf(",")?a.effect:a.effect.replace(" ","").split(",")[0],x=0>a.effect.indexOf(",")?n:a.effect.replace(" ","").split(",")[1],e=0,k=0,m=0,h=0,u,p,r,y,w,t;0>f&&(f=0);f>
g&&(f=g-1);a.start&&(h=f);a.randomize&&d.randomize();c("."+a.container,b).css({overflow:"hidden",position:"relative"});d.children().css({position:"absolute",top:0,zIndex:0,display:"none"});d.css({position:"relative",width:3*v,height:q});c("."+a.container,b).css({display:"block"});a.autoHeight&&(d.children().css({height:"auto"}),d.animate({height:d.children(":eq("+f+")").outerHeight()},a.autoHeightSpeed));a.preload&&d.find("img:eq("+f+")").length?(c("."+a.container,b).css({background:"url("+a.preloadImage+
") no-repeat 50% 50%"}),q=d.find("img:eq("+f+")").attr("src")+"?"+(new Date).getTime(),y="slides_control"!=c("img",b).parent().attr("class")?d.children(":eq(0)")[0].tagName.toLowerCase():d.find("img:eq("+f+")"),d.find("img:eq("+f+")").attr("src",q).load(function(){d.find(y+":eq("+f+")").fadeIn(a.fadeSpeed,a.fadeEasing,function(){c(this).css({zIndex:5});c("."+a.container,b).css({background:""});u=!0;a.slidesLoaded()})})):d.children(":eq("+f+")").fadeIn(a.fadeSpeed,a.fadeEasing,function(){u=!0;a.slidesLoaded()});
a.bigTarget&&(d.children().css({cursor:"pointer"}),d.children().on("click",function(){j("next",n);return!1}));a.hoverPause&&a.play&&(d.bind("mouseover",function(){clearInterval(b.data("interval"))}),d.bind("mouseleave",function(){l()}));a.generateNextPrev&&(c("."+a.container,b).after('<a href="#" class="'+a.prev+'">Prev</a>'),c("."+a.prev,b).after('<a href="#" class="'+a.next+'">Next</a>'));c("."+a.container,b).find("a").live("click",function(a){a.preventDefault();b.find(".uploader_background").fadeOut(250);
b.find(".paginator").fadeIn(250)});c("#gallery").on("click",function(a){a.stopPropagation()});c("html").on("click",function(){b.find(".uploader_background").fadeOut(250);b.find(".paginator").fadeIn(250)});c("."+a.next,b).on("click",function(b){b.preventDefault();a.play&&l();j("next",n)});c("."+a.prev,b).on("click",function(b){b.preventDefault();a.play&&l();j("prev",n)});a.generatePagination?(a.prependPagination?b.prepend('<div class="paginator"><ul class='+a.paginationClass+"></ul></div>"):(q="",
isAdmin&&(q='<ul class="controls"><li><a href="#" class="add"></a></li><li><a href="#" class="remove"></a></li></ul>'),b.append('<div class="paginator"><ul class='+a.paginationClass+"></ul>"+q+"</div>")),1==d.children().length&&b.find(".paginator").addClass("single"),d.children().each(function(){c("."+a.paginationClass,b).append('<li><a href="#'+m+'">'+(m+1)+"</a></li>");m++})):c("."+a.paginationClass+" li a",b).each(function(){c(this).attr("href","#"+m);m++});b.prepend('<div class="uploader_background"><div class="input"><input type="text" placeholder="URL of the image" /><a href="#" class="send">'+
gettext("Send")+"</a></div>");b.prepend('<div class="empty_background"><div class="empty"><span>'+gettext("No images yet")+'</span><a href="#" class="add"></a></div></div>');b.attr("data-empty")&&(c(".paginator .controls").hide(),c(".empty_background").show());c(".add").on("click",function(a){a.preventDefault();b.find(".uploader_background").fadeToggle(250);b.find(".paginator").fadeToggle(250)});c(".remove").on("click",function(f){f.preventDefault();var k=d.children(":eq("+h+")").attr("id").replace("item_",
""),f=b.attr("data-remove-url")+"/"+k;c.ajax({url:f,type:"POST",success:function(){b.find("#item_"+k).fadeOut(250,function(){c(this).remove();g=d.children().size();e=h=0;1>=g&&b.find(".paginator").addClass("single");1>g?(g++,h=0,e=1,d.append('<a href="#" id="item_0"><img src="/assets/img/slideshow.png" /></a>'),d.children(":eq(0)",b).css({position:"absolute",top:0,display:"none","z-index":0})):(c("."+a.paginationClass+" li:last-child").remove(),c("."+a.paginationClass+" li.selected").removeClass("selected"),
m--);if(1>g||1==g&&0<c("#gallery #item_0").length)c(".empty_background").fadeIn(250),c(".paginator .controls").fadeOut(250);j("next",n)})}})});c(".send").on("click",function(f){f.preventDefault();var l=b.find(".uploader_background input").val();isEmpty(l)||c.ajax({url:b.attr("data-url"),type:"POST",data:{image_url:l},dataType:"json",success:function(f){b.find(".uploader_background").fadeToggle(250);b.find(".paginator").fadeToggle(250);b.find(".uploader_background input").val("");d.append('<a href="#" id="item_'+
f.id+'"><img src="'+l+'" /></a>');d.children(":eq("+g+")",b).css({position:"absolute",top:0,display:"none","z-index":0});g=d.children().size();e=k=h=0;2==g&&0<!c("#gallery #item_0").length?(console.log(m),m=0):1<g&&b.find(".paginator").removeClass("single");c(".empty_background").fadeOut(250);c(".paginator .controls").fadeIn(250);c("."+a.paginationClass,b).append('<li><a href="#'+m+'">'+(m+1)+"</a></li>");m++;j("next",n)}})});c("."+a.paginationClass+" li:eq("+f+")",b).addClass(a.currentClass);c("."+
a.paginationClass+" li a",b).live("click",function(){a.play&&l();r=c(this).attr("href").match("[^#/]+$");h!=r&&j("pagination",x,r);return!1});c("a.link",b).on("click",function(){a.play&&l();r=c(this).attr("href").match("[^#/]+$")-1;h!=r&&j("pagination",x,r);return!1});a.play&&(t=setInterval(function(){j("next",n)},a.play),b.data("interval",t))})};c.fn.slides.option={preload:!1,preloadImage:"/img/loading.gif",container:"slides_container",generateNextPrev:!1,next:"next",prev:"prev",pagination:!0,generatePagination:!0,
prependPagination:!1,paginationClass:"pagination",currentClass:"current",fadeSpeed:350,fadeEasing:"",slideSpeed:350,slideEasing:"",start:1,effect:"slide",crossfade:!1,randomize:!1,play:0,pause:0,hoverPause:!1,autoHeight:!1,autoHeightSpeed:350,bigTarget:!1,animationStart:function(){},animationComplete:function(){},slidesLoaded:function(){}};c.fn.randomize=function(a){function j(){return Math.round(Math.random())-0.5}return c(this).each(function(){var l=c(this),b=l.children(),d=b.length;if(1<d){b.hide();
var g=[];for(i=0;i<d;i++)g[g.length]=i;g=g.sort(j);c.each(g,function(c,d){var f=b.eq(d),g=f.clone(!0);g.show().appendTo(l);void 0!==a&&a(f,g);f.remove()})}})}})(jQuery);
(function(f){f.cookie=function(g,b,a){if(1<arguments.length&&("[object String]"===Object.prototype.toString.call(b)||null===b||void 0===b)){a=f.extend({},a);if(null===b||void 0===b)a.expires=-1;if("number"===typeof a.expires){var d=a.expires,e=a.expires=new Date;e.setDate(e.getDate()+d)}b=String(b);return document.cookie=[encodeURIComponent(g),"=",a.raw?b:encodeURIComponent(b),a.expires?"; expires="+a.expires.toUTCString():"",a.path?"; path="+a.path:"",a.domain?"; domain="+a.domain:"",a.secure?"; secure":
""].join("")}for(var a=b||{},d=a.raw?function(a){return a}:decodeURIComponent,e=document.cookie.split("; "),h=0,c;c=e[h];h++)if(c=c.split("="),d(c[0])===g)return d(c[1]||"");return null}})(jQuery);
...
/*
 * spin.js v1.2.2
 * http://fgnass.github.com/spin.js#v1.2.2
 */
...
(function(a){a("html").addClass("stylish-select");Array.prototype.indexOf||(Array.prototype.indexOf=function(a){if(void 0===this||null===this)throw new TypeError;var u=Object(this),p=u.length>>>0;if(0===p)return-1;var c=0;0<arguments.length&&(c=Number(arguments[1]),c!==c?c=0:0!==c&&(c!==1/0&&c!==-(1/0))&&(c=(0<c||-1)*Math.floor(Math.abs(c))));if(c>=p)return-1;for(c=0<=c?c:Math.max(p-Math.abs(c),0);c<p;c++)if(c in u&&u[c]===a)return c;return-1});a.fn.extend({getSetSSValue:function(m){return m?(a(this).val(m).change(),
this):a(this).find(":selected").val()},resetSS:function(){var m=a(this).data("ssOpts");$this=a(this);$this.next().remove();$this.unbind(".sSelect").sSelect(m)}});a.fn.sSelect=function(m){return this.each(function(){function u(){e.offset();a(window).height();a(window).scrollTop();v>parseInt(s.ddMaxHeight)&&(v=parseInt(s.ddMaxHeight));j.css({height:v});n.css({top:B+"px",height:v});k.onTop=!1}function p(a,I){!0==a&&(z=d,k.change());!0==I&&(d=z,c(d));q.closest(".newListSelected").removeClass("newListOpened newListSelHover");
n.hide();e.css({position:"static"})}function c(a,c){if(-1==a)q.find("span").text(s.defaultText),l.removeClass("hiLite");else{l.removeClass("hiLite").eq(a).addClass("hiLite");var d=l.eq(a).text(),e=l.eq(a).parent().data("key");try{k.val(e)}catch(j){k[0].selectedIndex=a}q.find("span").text(d);!0==c&&(z=a,k.change());n.is(":visible")&&l.eq(a).focus()}}function H(b){a(b).unbind("keydown.sSelect").bind("keydown.sSelect",function(b){var i=b.which,b=b.shiftKey;w=!0;switch(i){case 40:case 39:return d<x-1&&
(++d,c(d)),!1;case 38:case 37:return 0<d&&(--d,c(d)),!1;case 33:case 36:return d=0,c(d),!1;case 34:case 35:return d=x-1,c(d),!1;case 13:case 27:return p(!0),!1;case 9:return p(!0),b?(i=a("body").find("button,input,textarea,select"),b=i.index(k),-1<b&&0<b-1&&i.eq(b-1).focus()):(i=a("body").find("button,input,textarea,select"),b=i.index(k),-1<b&&b+1<i.length&&i.eq(b+1).focus()),!1}keyPressed=String.fromCharCode(i).toLowerCase();if("undefined"!=typeof A.indexOf(keyPressed)){++d;d=A.indexOf(keyPressed,
d);if(-1==d||null==d||C!=keyPressed)d=A.indexOf(keyPressed);c(d);C=keyPressed;return!1}})}var y={defaultText:"Please select",animationSpeed:0,ddMaxHeight:"",containerClass:""},s=a.extend(y,m),k=a(this),q=a('<div class="selectedTxt"><span></span></div>'),e=a('<div class="newListSelected '+s.containerClass+'"></div>'),n=a('<div class="SSContainerDivWrapper" style="visibility:hidden;"></div>'),j=a('<ul class="newList"></ul>'),K=-1,d=-1,z=-1,A=[],C=!1,w=!1,l;a(this).data("ssOpts",m);y.width=a(this).parent().width();
e.insertAfter(k);e.attr("tabindex",k.attr("tabindex")||"0");q.prependTo(e);j.appendTo(e);j.wrap(n);n=j.parent();k.hide();e.find(".selectedTxt").width(y.width);e.find(".selectedTxt span").width(y.width-56);e.find(".SSContainerDivWrapper").width(y.width+1);q.data("ssReRender",!q.is(":visible"));0==k.children("optgroup").length?(k.children().each(function(b){var c=a(this).text(),i=a(this).val();A.push(c.charAt(0).toLowerCase());if("selected"==a(this).attr("selected")||!0==a(this).attr("selected"))s.defaultText=
c,d=z=b;j.append(a('<li><a href="JavaScript:void(0);">'+c+"</a></li>").data("key",i))}),l=j.children().children()):(k.children("optgroup").each(function(){var b=a(this).attr("label"),b=a('<li class="newListOptionTitle">'+b+"</li>"),c=a("<ul></ul>");b.appendTo(j);c.appendTo(b);a(this).children().each(function(){++K;var b=a(this).text(),e=a(this).val();A.push(b.charAt(0).toLowerCase());if("selected"==a(this).attr("selected")||!0==a(this).attr("selected"))s.defaultText=b,d=z=K;c.append(a('<li><a href="JavaScript:void(0);">'+
b+"</a></li>").data("key",e))})}),l=j.find("ul li a"));var v=j.height(),B=e.height(),x=l.length;j.lionbars();-1!=d?c(d):q.find("span").text(s.defaultText);u();a(window).bind("resize.sSelect scroll.sSelect",u);q.bind("click.sSelect",function(b){b.stopPropagation();a(this).data("ssReRender")&&(v=j.height("").height(),n.height(""),B=e.height(),a(this).data("ssReRender",!1),u());a(".SSContainerDivWrapper").not(a(this).next()).hide().parent().css("position","static").removeClass("newListSelFocus");n.is(":visible")?
a(this).closest(".newListSelected").removeClass("newListOpened"):a(this).closest(".newListSelected").addClass("newListOpened");n.toggle();e.css("position","relative");-1==d&&(d=0);l.eq(d).focus()});l.bind("click.sSelect",function(b){b=a(b.target);d=l.index(b);w=!0;c(d,!0);p()});l.bind("mouseenter.sSelect",function(b){a(b.target).addClass("newListHover")}).bind("mouseleave.sSelect",function(b){a(b.target).removeClass("newListHover")});k.bind("change.sSelect",function(b){b=a(b.target);if(!0==w)return w=
!1;var e=b.find(":selected");d=b.find("option").index(e);c(d)});e.bind("click.sSelect",function(a){a.stopPropagation();H(this)});e.bind("focus.sSelect",function(){a(this).addClass("newListSelFocus");H(this)});e.bind("blur.sSelect",function(){a(this).removeClass("newListSelFocus")});a(document).bind("click.sSelect",function(){e.removeClass("newListSelFocus");n.is(":visible")?p(!1,!0):p(!1)});k.focus(function(){k.next().focus()});q.bind("mouseenter.sSelect",function(b){a(b.target).parent().addClass("newListSelHover")}).bind("mouseleave.sSelect",
function(b){a(b.target).parent().removeClass("newListSelHover")});n.css({left:"0",display:"none",visibility:"visible"})})}})(jQuery);
(function(a){a.fn.hasScrollBar=function(){return this.get(0).scrollHeight>this.height()};a.fn.lionbars=function(m){function u(b){var f=a(b);(t||i)&&f.find(".lb-wrap").scroll(function(){f.find(".lb-v-scrollbar-slider").css({top:-a(this).scrollTop()/f.attr("vratio")});f.find(".lb-h-scrollbar-slider").css({left:-a(this).scrollLeft()/f.attr("hratio")});if(f.find(".lb-v-scrollbar").height()==parseInt(f.find(".lb-v-scrollbar-slider").css("top"))+f.find(".lb-v-scrollbar-slider").height()&&"function"==typeof m.reachedBottom&&
!l){l=!0;var b=a(this);m.reachedBottom.apply(a(this).children(".lb-content"),[function(){s(a(b).parent(),{height:a(b).children(".lb-content").get(0).scrollHeight,width:a(b).children(".lb-content").get(0).scrollWidth});y(a(b).parent());c(a(b).parent());p(a(b).parent());H();l=!1}])}f.find(".lb-h-scrollbar").width()==parseInt(f.find(".lb-h-scrollbar-slider").css("left"))+f.find(".lb-h-scrollbar-slider").width()&&("function"==typeof m.reachedRight&&!v)&&(v=!0,b=a(this),m.reachedRight.apply(a(this).children(".lb-content"),
[function(){s(a(b).parent(),{height:a(b).children(".lb-content").get(0).scrollHeight,width:a(b).children(".lb-content").get(0).scrollWidth});y(a(b).parent());c(a(b).parent());p(a(b).parent());H();v=!1}]));autohide&&(f.find(".lb-v-scrollbar, .lb-h-scrollbar").fadeIn(150),clearTimeout(k),k=setTimeout(function(){f.find(".lb-v-scrollbar, .lb-h-scrollbar").fadeOut(150)},2E3))});t&&(f.find(".lb-v-scrollbar-slider").mousedown(function(b){d=b.pageY;e=!0;n=a(this);j=f.find(".lb-wrap");C=j.parent().attr("vratio");
w=n.position().top;return!1}),f.find(".lb-v-scrollbar").mousedown(function(b){a(b.target).hasClass("lb-v-scrollbar-slider")||f.find(".lb-wrap").scrollTop((b.pageY-a(this).offset().top)*Math.abs(f.attr("vratio"))-a(this).find(".lb-v-scrollbar-slider").height()/2);return!1}));i&&(f.find(".lb-h-scrollbar-slider").mousedown(function(b){K=b.pageX;q=!0;n=a(this);j=f.find(".lb-wrap");C=j.parent().attr("hratio");w=n.position().left;return!1}),f.find(".lb-h-scrollbar").mousedown(function(b){a(b.target).hasClass("lb-h-scrollbar-slider")||
f.find(".lb-wrap").scrollLeft((b.pageX-a(this).offset().left)*Math.abs(f.attr("hratio"))-a(this).find(".lb-h-scrollbar-slider").width()/2);return!1}));if((t||i)&&autohide)f.find(".lb-v-scrollbar, .lb-h-scrollbar").hide(),f.hover(function(){},function(){f.find(".lb-v-scrollbar, .lb-h-scrollbar").fadeOut(150)})}function p(b){aa=(D-a(b).find(".lb-wrap").get(0).scrollHeight-R-S)/(L-E);ba=(F-a(b).find(".lb-wrap").get(0).scrollWidth-T-U)/(M-G);b=a(b);b.attr("vratio",aa);b.attr("hratio",ba)}function c(b){var b=
a(b),c,d;0!=b.find(".lb-v-scrollbar").length&&(c=20,d=D-b.find(".lb-v-scrollbar").height(),d=D-d-c,E=Math.round(D*d/V),E=E<c?c:E);0!=b.find(".lb-h-scrollbar").length&&(c=20,d=F-b.find(".lb-h-scrollbar").width(),d=F-d-c,G=Math.round(F*d/W),G=G<c?c:G);b.find(".lb-v-scrollbar-slider").css({height:E});b.find(".lb-h-scrollbar-slider").css({width:G})}function H(){I=b=0;t=i=!1;M=L=G=E=X=Y=D=F=W=V=U=S=T=R=N=O=P=J=0}function y(b){b=a(b);t&&i?(L=b.height()-12,M=b.width()-12):(L=b.height()-4,M=b.width()-4);
b.find(".lb-v-scrollbar").css({height:L});b.find(".lb-h-scrollbar").css({width:M})}function s(c,d){var e=a(c).get(0);V="undefined"!=typeof d?d.height:e.scrollHeight;W="undefined"!=typeof d?d.width:e.scrollWidth;X=e.clientHeight;Y=e.clientWidth;D=e.offsetHeight;F=e.offsetWidth;e=a(c);e=a(e);e.css({overflow:"auto"});b=F-Y-T-U;e.css({overflow:"hidden"});e=a(c);e=a(e);e.css({overflow:"auto"});I=D-X-R-S;e.css({overflow:"hidden"})}m=m||{};autohide=m.autohide;for(var k,q=!1,e=!1,n=0,j=0,K,d,z,A,C,w,l=!1,
v=!1,B=a(this),x=0,b=0,I=0,i=!1,t=!1,J=0,P=0,O=0,N=0,R=0,U=0,S=0,T=0,V=0,W=0,F=0,D=0,Y=0,X=0,aa=0,ba=0,E=0,G=0,L=0,M=0,Q=0;void 0!==B[Q];Q++){var g;g=a(B[Q]);var i=t=!1,h=a(g),J=parseInt(h.css("padding-top").replace("px","")),P=parseInt(h.css("padding-left").replace("px","")),O=parseInt(h.css("padding-bottom").replace("px","")),N=parseInt(h.css("padding-right").replace("px","")),h=a(g),R=parseInt(h.css("border-top-width").replace("px","")),U=parseInt(h.css("border-right-width").replace("px","")),
S=parseInt(h.css("border-bottom-width").replace("px","")),T=parseInt(h.css("border-left-width").replace("px",""));g.css({overflow:"hidden"});g.get(0).scrollHeight>g.get(0).clientHeight&&(t=!0);g.get(0).scrollWidth>g.get(0).clientWidth&&(i=!0);g.css({overflow:"auto"});g=t||i?!0:void 0;if(g&&!a(B[Q]).hasClass("nolionbars")){target=B[Q];s(target);g=t;var h=i,r=a(target),Z=r.attr("id"),$=0;void 0!==Z?(r.wrapInner('<div class="lb-wrap" id="lb-wrap-'+x+"-"+Z+'"></div>'),$=a("#lb-wrap-"+x+"-"+Z)):(r.wrapInner('<div class="lb-wrap" id="lb-wrap-'+
x+'"></div>'),$=a("#lb-wrap-"+x));$.wrapInner('<div class="lb-content"></div>');g&&(r.prepend('<div class="lb-v-scrollbar"></div>'),r.find(".lb-v-scrollbar").append('<div class="lb-v-scrollbar-slider"></div>'));h&&(r.prepend('<div class="lb-h-scrollbar"></div>'),r.find(".lb-h-scrollbar").append('<div class="lb-h-scrollbar-slider"></div>'));x+=1;h=t;r=i;g=a(target);if(h||r)g.css({overflow:"hidden"}),r=g.find(".lb-wrap"),h=a(g),r=a(r),h.css({padding:0}),r.css({"padding-top":J+"px","padding-left":P+
"px","padding-bottom":O+"px","padding-right":N+"px"}),h=a(g),h.css({width:h.width()+P+N,height:h.height()+J+O}),h=g.find(".lb-wrap"),g=a(g),h=a(h),g.css({position:"relative"}),h.css({width:g.width()+b-P-N,height:g.height()+I-J-O});y(target);c(target);p(target);u(target);H()}}a(document).mousemove(function(a){e&&(A=a.pageY,j.scrollTop((w+A-d)*Math.abs(C)));q&&(z=a.pageX,j.scrollLeft((w+z-K)*Math.abs(C)))});a(document).mouseup(function(){e&&(e=!1);q&&(q=!1)});return this.each(function(){})}})(jQuery);
...
qq.FileUploaderBasic=function(a){this._options={debug:!1,action:"/server/upload",params:{},button:null,multiple:!1,maxConnections:3,allowedExtensions:[],sizeLimit:0,minSizeLimit:0,onSubmit:function(){},onProgress:function(){},onComplete:function(){},onCancel:function(){},messages:{typeError:"{file} has invalid extension. Only {extensions} are allowed.",sizeError:"{file} is too large, maximum file size is {sizeLimit}.",minSizeError:"{file} is too small, minimum file size is {minSizeLimit}.",emptyError:"{file} is empty, please select files again without it.",
...
qq.FileUploader=function(a){qq.FileUploaderBasic.apply(this,arguments);qq.extend(this._options,{element:null,listElement:null,template:'<div class="qq-uploader"><div class="qq-upload-drop-area"><span>Drop files here to upload</span></div><div class="qq-upload-button">Drop your file here or <a>select it from your computer</a></div><ul class="qq-upload-list"></ul></div>',fileTemplate:'<li><span class="qq-upload-file"></span><span class="qq-upload-spinner"></span><span class="qq-upload-size"></span><a class="qq-upload-cancel" href="#">Cancel</a><a class="qq-upload-change" href="#">Change</a><span class="qq-upload-failed-text">Failed</span></li>',
classes:{button:"qq-upload-button",drop:"qq-upload-drop-area",dropActive:"qq-upload-drop-area-active",list:"qq-upload-list",file:"qq-upload-file",spinner:"qq-upload-spinner",size:"qq-upload-size",cancel:"qq-upload-cancel",change:"qq-upload-change",success:"qq-upload-success",fail:"qq-upload-fail"}});qq.extend(this._options,a);this._element=this._options.element;this._element.innerHTML=this._options.template;this._listElement=this._options.listElement||this._find(this._element,"list");this._classes=
...
b,c,d){qq.FileUploaderBasic.prototype._onProgress.apply(this,arguments);var e=this._getItemByFileId(a);this._find(e,"change").style.display="none";e=this._find(e,"size");e.style.display="inline";var f;f=c!=d?Math.round(100*(c/d))+"%":this._formatSize(d);qq.setText(e,f)},_onComplete:function(a,b,c){qq.FileUploaderBasic.prototype._onComplete.apply(this,arguments);var d=this._getItemByFileId(a);qq.remove(this._find(d,"cancel"));qq.remove(this._find(d,"spinner"));qq.remove(this._find(d,"size"));var e=
this._find(d,"change");e.style.display="inline";c.success?(e.innerText="Change",qq.addClass(d,this._classes.success)):(e.innerText="Retry",qq.addClass(d,this._classes.fail))},_addToList:function(a,b){var c=qq.toElement(this._options.fileTemplate);c.qqFileId=a;var d=this._find(c,"file");qq.setText(d,this._formatFileName(b));this._find(c,"size").style.display="none";this._listElement.appendChild(c)},_getItemByFileId:function(a){for(var b=this._listElement.firstChild;b;){if(b.qqFileId==a)return b;b=
b.nextSibling}},_bindCancelEvent:function(){var a=this;qq.attach(this._listElement,"click",function(b){var b=b||window.event,c=b.target||b.srcElement;if(qq.hasClass(c,a._classes.cancel)||qq.hasClass(c,a._classes.change)){qq.preventDefault(b);var b=c.parentNode,d=$(b).closest(".qq-uploader");qq.hasClass(c,a._classes.cancel)?a._handler.cancel(b.qqFileId):d.find('input[name="file"]').click();qq.remove(b)}})}});
...
(function(b){b.widget("ui.tagit",{options:{itemName:"item",fieldName:"tags",availableTags:[],tagSource:null,removeConfirmation:!1,caseSensitive:!0,placeholderText:null,allowSpaces:!1,animate:!0,singleField:!1,singleFieldDelimiter:",",singleFieldNode:null,tabIndex:null,onTagAdded:null,onTagRemoved:null,onTagClicked:null},_create:function(){var a=this;this.element.is("input")?(this.tagList=b("<ul></ul>").insertAfter(this.element),this.tagList.append('<span class="top"></span><span class="bottom"></span>'),
this.options.singleField=!0,this.options.singleFieldNode=this.element,this.element.css("display","none")):this.tagList=this.element.find("ul, ol").andSelf().last();this._tagInput=b('<input type="text" class="first" />').addClass("ui-widget-content");this.options.tabIndex&&this._tagInput.attr("tabindex",this.options.tabIndex);this.options.placeholderText&&this._tagInput.attr("placeholder",this.options.placeholderText);this.options.tagSource=this.options.tagSource||function(a,c){var d=a.term.toLowerCase(),
h=b.grep(this.options.availableTags,function(a){return 0===a.toLowerCase().indexOf(d)});c(this._subtractArray(h,this.assignedTags()))};b.isFunction(this.options.tagSource)&&(this.options.tagSource=b.proxy(this.options.tagSource,this));this.tagList.addClass("tagit").addClass("ui-widget ui-widget-content ui-corner-all").append(b('<li class="tagit-new"></li>').append(this._tagInput)).click(function(e){var c=b(e.target);c.hasClass("tagit-label")?a._trigger("onTagClicked",e,c.closest(".tagit-choice")):
a._tagInput.focus()});this.tagList.children("li").each(function(){b(this).hasClass("tagit-new")||(a.createTag(b(this).html(),b(this).attr("class")),b(this).remove())});if(this.options.singleField)if(this.options.singleFieldNode){var c=b(this.options.singleFieldNode),d=c.val().split(this.options.singleFieldDelimiter);c.val("");b.each(d,function(b,c){a.createTag(c)})}else this.options.singleFieldNode=this.tagList.after('<input type="hidden" style="display:none;" value="" name="'+this.options.fieldName+
'" />');this._tagInput.keydown(function(c){if(c.which==b.ui.keyCode.BACKSPACE&&""===a._tagInput.val()){var d=a._lastTag();!a.options.removeConfirmation||d.hasClass("remove")?a.removeTag(d):a.options.removeConfirmation&&d.addClass("remove ui-state-highlight")}else a.options.removeConfirmation&&a._lastTag().removeClass("remove ui-state-highlight");if(c.which==b.ui.keyCode.COMMA||c.which==b.ui.keyCode.ENTER||c.which==b.ui.keyCode.TAB&&""!==a._tagInput.val()||c.which==b.ui.keyCode.SPACE&&!0!==a.options.allowSpaces&&
('"'!=b.trim(a._tagInput.val()).replace(/^s*/,"").charAt(0)||'"'==b.trim(a._tagInput.val()).charAt(0)&&'"'==b.trim(a._tagInput.val()).charAt(b.trim(a._tagInput.val()).length-1)&&0!==b.trim(a._tagInput.val()).length-1))c.preventDefault(),a.createTag(a._cleanedInput()),a._tagInput.autocomplete("close")}).blur(function(){a.createTag(a._cleanedInput())}).focusout(function(){b(this).closest("ul").removeClass("focus")}).focusin(function(){b(this).closest("ul").addClass("focus")});(this.options.availableTags||
this.options.tagSource)&&this._tagInput.autocomplete({source:this.options.tagSource,select:function(b,c){""===a._tagInput.val()&&a.removeTag(a._lastTag(),!1);a.createTag(c.item.value);return!1}})},_cleanedInput:function(){return b.trim(this._tagInput.val().replace(/^"(.*)"$/,"$1"))},_lastTag:function(){return this.tagList.children(".tagit-choice:last")},assignedTags:function(){var a=this,c=[];this.options.singleField?(c=b(this.options.singleFieldNode).val().split(this.options.singleFieldDelimiter),
""===c[0]&&(c=[])):this.tagList.children(".tagit-choice").each(function(){c.push(a.tagLabel(this))});return c},_updateSingleTagsField:function(a){b(this.options.singleFieldNode).val(a.join(this.options.singleFieldDelimiter))},_subtractArray:function(a,c){for(var d=[],e=0;e<a.length;e++)-1==b.inArray(a[e],c)&&d.push(a[e]);return d},tagLabel:function(a){return this.options.singleField?b(a).children(".tagit-label").text():b(a).children("input").val()},_isNew:function(a){var b=this,d=!0;this.tagList.children(".tagit-choice").each(function(){if(b._formatStr(a)==
b._formatStr(b.tagLabel(this)))return d=!1});return d},_formatStr:function(a){return this.options.caseSensitive?a:b.trim(a.toLowerCase())},createTag:function(a,c){var d=this,a=b.trim(a);if(!this._isNew(a)||""===a)return!1;var e=b(this.options.onTagClicked?'<a class="tagit-label"></a>':'<span class="tagit-label"></span>').text(a),f=b("<li></li>").addClass("tagit-choice ui-widget-content ui-state-default ui-corner-all").addClass(c).append(e),g=b("<span></span>").addClass("ui-icon ui-icon-close"),g=
b('<a><span class="text-icon">\u00d7</span></a>').addClass("tagit-close").append(g).click(function(){d.removeTag(f)});f.append(g);this.options.singleField?(e=this.assignedTags(),e.push(a),this._updateSingleTagsField(e)):(e=e.html(),f.append('<input type="hidden" style="display:none;" value="'+e+'" name="'+this.options.itemName+"["+this.options.fieldName+'][]" />'));this._trigger("onTagAdded",null,f);this._tagInput.val("");this._tagInput.parent().before(f);this.tagList.find("input").removeClass("first").removeAttr("placeholder")},
removeTag:function(a){a=b(a);this._trigger("onTagRemoved",null,a);if(this.options.singleField){var c=this.assignedTags(),d=this.tagLabel(a),c=b.grep(c,function(a){return a!=d});this._updateSingleTagsField(c)}a.remove();0==this.tagList.children(".tagit-choice").size()&&this.tagList.find("input").addClass("first").attr("placeholder",this.options.placeholderText)},removeAll:function(){var a=this;this.tagList.children(".tagit-choice").each(function(b,d){a.removeTag(d,!1)})}})})(jQuery);
(function(a){a.widget("ui.addresspicker",{options:{appendAddressString:"",elements:{map:!1,lat:!1,lng:!1,locality:!1,country:!1}},selected:function(){return this.selectedResult},_create:function(){this.geocoder=new google.maps.Geocoder;this.element.autocomplete({source:a.proxy(this._geocode,this),focus:a.proxy(this._focusAddress,this),select:a.proxy(this._selectAddress,this)})},_geocode:function(d,c){this.geocoder.geocode({address:d.term+this.options.appendAddressString},function(b,d){3<b.length&&
(b=b.slice(0,3));if(d==google.maps.GeocoderStatus.OK)for(var a=0;a<b.length;a++)b[a].label=b[a].formatted_address;c(b)})},_findInfo:function(a,c){for(var b=0;b<a.address_components.length;b++){var e=a.address_components[b];if(-1!=e.types.indexOf(c))return e.long_name}return!1},_focusAddress:function(a,c){var b=c.item;b&&(this.locality&&this.locality.val(this._findInfo(b,"locality")),this.country&&this.country.val(this._findInfo(b,"country")))},_selectAddress:function(a,c){this.selectedResult=c.item}});
a.extend(a.ui.addresspicker,{version:"@VERSION"});Array.indexOf||(Array.prototype.indexOf=function(a){for(var c=0;c<this.length;c++)if(this[c]==a)return c;return-1})})(jQuery);
...
D=function(){return w.pushState&&d.state!==i},O=function(){return("/"+k.pathname.replace(RegExp(d.state),"")+k.search+(E()?"#"+E():"")).replace(N,"/")},E=function(){var a=k.href.indexOf("#");return-1!=a?q(k.href.substr(a+1),j):""},n=function(){return D()?O():E()},K=function(a){a=a.toString();return(d.strict&&"/"!=a.substr(0,1)?"/":"")+a},q=function(a,b){return d.crawlable&&b?(""!==a?"!":"")+a:a.replace(/^\!/,"")},p=function(a,b){return parseInt(a.css(b),10)},A=function(){if(!F){var a=n();e!=a&&(x&&
7>y?k.reload():(x&&(!G&&d.history)&&m(L,50),e=a,z(j)))}},z=function(a){J(P);J(a?Q:R);m(Y,10)},Y=function(){if("null"!==d.tracker&&null!==d.tracker){var a=c.isFunction(d.tracker)?d.tracker:f[d.tracker],b=(k.pathname+k.search+(c.address&&!D()?c.address.value():"")).replace(/\/\//,"/").replace(/^\/$/,"");c.isFunction(a)?a(b):c.isFunction(f.urchinTracker)?f.urchinTracker(b):f.pageTracker!==i&&c.isFunction(f.pageTracker._trackPageview)?f.pageTracker._trackPageview(b):f._gaq!==i&&c.isFunction(f._gaq.push)&&
f._gaq.push(["_trackPageview",decodeURI(b)])}},L=function(){var a="javascript:"+j+";document.open();document.writeln('<html><head><title>"+g.title.replace(/\'/g,"\\'")+"</title><script>var "+r+' = "'+n()+(g.domain!=k.hostname?'";document.domain="'+g.domain:"")+"\";<\/script></head></html>');document.close();";7>y?h.src=a:h.contentWindow.location.replace(a)},T=function(){if(B&&-1!=S){var a,b,c=B.substr(S+1).split("&");for(a=0;a<c.length;a++)b=c[a].split("="),/^(autoUpdate|crawlable|history|strict|wrap)$/.test(b[0])&&
(d[b[0]]=isNaN(b[1])?/^(true|yes)$/i.test(b[1]):0!==parseInt(b[1],10)),/^(state|tracker)$/.test(b[0])&&(d[b[0]]=b[1]);B=null}e=n()},V=function(){if(!U){U=l;T();var a=function(){var a,b=c("a"),e=b.size(),f=-1,i=function(){++f!=e&&(a=c(b.get(f)),a.is('[rel*="address:"]')&&a.address('[rel*="address:"]'),m(i,1))};m(i,1);if(d.crawlable){var h=k.pathname.replace(/\/$/,"");-1!=c("body").html().indexOf("_escaped_fragment_")&&c('a[href]:not([href^=http]), a[href*="'+document.domain+'"]').each(function(){var a=
...
r+'" style="height:100%;overflow:auto;position:relative;'+(H&&!window.statusbar.visible?"resize:both;":"")+'" />'),c("html, body").css({height:"100%",margin:0,padding:0,overflow:"hidden"}),H&&c('<style type="text/css" />').appendTo("head").text("#"+r+"::-webkit-resizer { background-color: #fff; }"));x&&!G&&(a=g.getElementsByTagName("frameset")[0],h=g.createElement((a?"":"i")+"frame"),h.src="javascript:"+j,a?(a.insertAdjacentElement("beforeEnd",h),a[a.cols?"cols":"rows"]+=",0",h.noResize=l,h.frameBorder=
h.frameSpacing=0):(h.style.display="none",h.style.width=h.style.height=0,h.tabIndex=-1,g.body.insertAdjacentElement("afterBegin",h)),m(function(){c(h).bind("load",function(){var a=h.contentWindow;e=a[r]!==i?a[r]:"";e!=n()&&(z(j),k.hash=q(e,l))});h.contentWindow[r]===i&&L()},50));m(function(){J("init");z(j)},1);D()||(G?f.addEventListener?f.addEventListener(C,A,j):f.attachEvent&&f.attachEvent("on"+C,A):Z(A,50));"state"in window.history&&c(window).trigger("popstate")}},i,r="jQueryAddress",C="hashchange",
P="change",Q="internalChange",R="externalChange",l=!0,j=!1,d={autoUpdate:l,crawlable:j,history:l,strict:l,wrap:j},s=c.browser,y=parseFloat(s.version),x=!c.support.opacity,H=s.webkit||s.safari,f;try{f=top.document!==i?top:window}catch(aa){f=window}var g=f.document,w=f.history,k=f.location,Z=setInterval,m=setTimeout,N=/\/{2,9}/g,s=navigator.userAgent,G="on"+C in f,h,B=c("script:last").attr("src"),S=B?B.indexOf("?"):-1,M=g.title,F=j,U=j,W=l,I=j,e=n();if(x){y=parseFloat(s.substr(s.indexOf("MSIE")+4));
g.documentMode&&g.documentMode!=y&&(y=8!=g.documentMode?7:8);var X=g.onpropertychange;g.onpropertychange=function(){X&&X.call(g);g.title!=M&&-1!=g.title.indexOf("#"+n())&&(g.title=M)}}w.navigationMode&&(w.navigationMode="compatible");if("complete"==document.readyState)var $=setInterval(function(){c.address&&(V(),clearInterval($))},50);else T(),c(V);c(window).bind("popstate",function(){e!=n()&&(e=n(),z(j))}).bind("unload",function(){f.removeEventListener?f.removeEventListener(C,A,j):f.detachEvent&&
f.detachEvent("on"+C,A)});c.address={bind:function(a,b,c){return v.apply(this,u(arguments))},init:function(a,b){return v.apply(this,["init"].concat(u(arguments)))},change:function(a,b){return v.apply(this,[P].concat(u(arguments)))},internalChange:function(a,b){return v.apply(this,[Q].concat(u(arguments)))},externalChange:function(a,b){return v.apply(this,[R].concat(u(arguments)))},baseURL:function(){var a=k.href;-1!=a.indexOf("#")&&(a=a.substr(0,a.indexOf("#")));/\/$/.test(a)&&(a=a.substr(0,a.length-
1));return a},autoUpdate:function(a){return a!==i?(d.autoUpdate=a,this):d.autoUpdate},crawlable:function(a){return a!==i?(d.crawlable=a,this):d.crawlable},history:function(a){return a!==i?(d.history=a,this):d.history},state:function(a){if(a!==i){d.state=a;var b=O();d.state!==i&&(w.pushState?"/#/"==b.substr(0,3)&&k.replace(d.state.replace(/^\/$/,"")+b.substr(2)):"/"!=b&&b.replace(/^\/#/,"")!=E()&&m(function(){k.replace(d.state.replace(/^\/$/,"")+"/#"+b)},1));return this}return d.state},strict:function(a){return a!==
i?(d.strict=a,this):d.strict},tracker:function(a){return a!==i?(d.tracker=a,this):d.tracker},wrap:function(a){return a!==i?(d.wrap=a,this):d.wrap},update:function(){I=l;this.value(e);I=j;return this},title:function(a){return a!==i?(m(function(){M=g.title=a;W&&(h&&h.contentWindow&&h.contentWindow.document)&&(h.contentWindow.document.title=a,W=j)},50),this):g.title},value:function(a){if(a!==i){a=K(a);"/"==a&&(a="");if(e==a&&!I)return;e=a;if(d.autoUpdate||I)if(z(l),D())w[d.history?"pushState":"replaceState"]({},
"",d.state.replace(/\/$/,"")+(""===e?"/":e));else F=l,H?d.history?k.hash="#"+q(e,l):k.replace("#"+q(e,l)):e!=n()&&(d.history?k.hash="#"+q(e,l):k.replace("#"+q(e,l))),x&&!G&&d.history&&m(L,50),H?m(function(){F=j},1):F=j;return this}return K(e)},path:function(a){if(a!==i){var b=this.queryString(),c=this.hash();this.value(a+(b?"?"+b:"")+(c?"#"+c:""));return this}return K(e).split("#")[0].split("?")[0]},pathNames:function(){var a=this.path(),b=a.replace(N,"/").split("/");("/"==a.substr(0,1)||0===a.length)&&
b.splice(0,1);"/"==a.substr(a.length-1,1)&&b.splice(b.length-1,1);return b},queryString:function(a){if(a!==i){var b=this.hash();this.value(this.path()+(a?"?"+a:"")+(b?"#"+b:""));return this}a=e.split("?");return a.slice(1,a.length).join("?").split("#")[0]},parameter:function(a,b,d){var e,f;if(b!==i){var h=this.parameterNames();f=[];b=b===i||null===b?"":b.toString();for(e=0;e<h.length;e++){var j=h[e],g=this.parameter(j);"string"==typeof g&&(g=[g]);j==a&&(g=null===b||""===b?[]:d?g.concat([b]):[b]);
for(var k=0;k<g.length;k++)f.push(j+"="+g[k])}-1==c.inArray(a,h)&&(null!==b&&""!==b)&&f.push(a+"="+b);this.queryString(f.join("&"));return this}if(b=this.queryString()){d=[];f=b.split("&");for(e=0;e<f.length;e++)b=f[e].split("="),b[0]==a&&d.push(b.slice(1).join("="));if(0!==d.length)return 1!=d.length?d:d[0]}},parameterNames:function(){var a=this.queryString(),b=[];if(a&&-1!=a.indexOf("="))for(var a=a.split("&"),d=0;d<a.length;d++){var e=a[d].split("=")[0];-1==c.inArray(e,b)&&b.push(e)}return b},
hash:function(a){if(a!==i)return this.value(e.split("#")[0]+(a?"#"+a:"")),this;a=e.split("#");return a.slice(1,a.length).join("#")}};c.fn.address=function(a){var b;"string"==typeof a&&(b=a,a=void 0);c(this).attr("address")||c(b?b:this).live("click",function(b){if(b.shiftKey||b.ctrlKey||b.metaKey||2==b.which)return!0;c(this).is("a")&&(b.preventDefault(),b=a?a.call(this):/address:/.test(c(this).attr("rel"))?c(this).attr("rel").split("address:")[1].split(" ")[0]:void 0!==c.address.state()&&!/^\/?$/.test(c.address.state())?
c(this).attr("href").replace(RegExp("^(.*"+c.address.state()+"|\\.)"),""):c(this).attr("href").replace(/^(#\!?|\.)/,""),c.address.value(b))}).live("submit",function(b){c(this).is("form")&&(b.preventDefault(),b=c(this).attr("action"),b=a?a.call(this):(-1!=b.indexOf("?")?b.replace(/&$/,""):b+"?")+c(this).serialize(),c.address.value(b))}).attr("address",!0);return this}})(jQuery);
(function(c){var J=function(a){c(c.address).trigger(c.extend(c.Event(a),function(){for(var a={},t=c.address.parameterNames(),d=0,e=t.length;d<e;d++)a[t[d]]=c.address.parameter(t[d]);return{value:c.address.value(),path:c.address.path(),pathNames:c.address.pathNames(),parameterNames:t,parameters:a,queryString:c.address.queryString()}}.call(c.address)))},u=function(a){return Array.prototype.slice.call(a)},v=function(a,b,t){c().bind.apply(c(c.address),Array.prototype.slice.call(arguments));return c.address},
D=function(){return w.pushState&&d.state!==i},O=function(){return("/"+k.pathname.replace(RegExp(d.state),"")+k.search+(E()?"#"+E():"")).replace(N,"/")},E=function(){var a=k.href.indexOf("#");return-1!=a?q(k.href.substr(a+1),j):""},n=function(){return D()?O():E()},K=function(a){a=a.toString();return(d.strict&&"/"!=a.substr(0,1)?"/":"")+a},q=function(a,b){return d.crawlable&&b?(""!==a?"!":"")+a:a.replace(/^\!/,"")},p=function(a,b){return parseInt(a.css(b),10)},A=function(){if(!F){var a=n();e!=a&&(x&&
7>y?k.reload():(x&&(!G&&d.history)&&m(L,50),e=a,z(j)))}},z=function(a){J(P);J(a?Q:R);m(Y,10)},Y=function(){if("null"!==d.tracker&&null!==d.tracker){var a=c.isFunction(d.tracker)?d.tracker:f[d.tracker],b=(k.pathname+k.search+(c.address&&!D()?c.address.value():"")).replace(/\/\//,"/").replace(/^\/$/,"");c.isFunction(a)?a(b):c.isFunction(f.urchinTracker)?f.urchinTracker(b):f.pageTracker!==i&&c.isFunction(f.pageTracker._trackPageview)?f.pageTracker._trackPageview(b):f._gaq!==i&&c.isFunction(f._gaq.push)&&
f._gaq.push(["_trackPageview",decodeURI(b)])}},L=function(){var a="javascript:"+j+";document.open();document.writeln('<html><head><title>"+g.title.replace(/\'/g,"\\'")+"</title><script>var "+r+' = "'+n()+(g.domain!=k.hostname?'";document.domain="'+g.domain:"")+"\";<\/script></head></html>');document.close();";7>y?h.src=a:h.contentWindow.location.replace(a)},T=function(){if(B&&-1!=S){var a,b,c=B.substr(S+1).split("&");for(a=0;a<c.length;a++)b=c[a].split("="),/^(autoUpdate|crawlable|history|strict|wrap)$/.test(b[0])&&
...
clearTimeout(this.timeout);b.hoverState="in";this.timeout=setTimeout(function(){"in"==b.hoverState&&b.show()},b.options.delay.show)},leave:function(a){var b=c(a.currentTarget)[this.type](this._options).data(this.type);this.timeout&&clearTimeout(this.timeout);if(!b.options.delay||!b.options.delay.hide)return b.hide();b.hoverState="out";this.timeout=setTimeout(function(){"out"==b.hoverState&&b.hide()},b.options.delay.hide)},show:function(){var a,b,d,c,e,f,g;if(this.hasContent()&&this.enabled){a=this.tip();
this.setContent();this.options.animation&&a.addClass("fade");f="function"==typeof this.options.placement?this.options.placement.call(this,a[0],this.$element[0]):this.options.placement;b=/in/.test(f);a.remove().css({top:0,left:0,display:"block"}).appendTo(b?this.$element:document.body);d=this.getPosition(b);c=a[0].offsetWidth;e=a[0].offsetHeight;switch(b?f.split(" ")[1]:f){case "bottom":g={top:d.top+d.height,left:d.left+d.width/2-c/2};break;case "top":g={top:d.top-e,left:d.left+d.width/2-c/2};break;
case "left":g={top:d.top+d.height/2-e/2,left:d.left-c};break;case "right":g={top:d.top+d.height/2-e/2,left:d.left+d.width}}a.css(g).addClass(f).addClass("in")}},setContent:function(){var a=this.tip(),b=this.getTitle();a.find(".bt_tooltip-inner")[this.options.html?"html":"text"](b);a.removeClass("fade in top bottom left right")},hide:function(){var a=this.tip();a.removeClass("in");if(c.support.transition&&this.$tip.hasClass("fade")){var b=setTimeout(function(){a.off(c.support.transition.end).remove()},
500);a.one(c.support.transition.end,function(){clearTimeout(b);a.remove()})}else a.remove();return this},fixTitle:function(){var a=this.$element;if(a.attr("title")||"string"!=typeof a.attr("data-original-title"))a.attr("data-original-title",a.attr("title")||"").removeAttr("title")},hasContent:function(){return this.getTitle()},getPosition:function(a){return c.extend({},a?{top:0,left:0}:this.$element.offset(),{width:this.$element[0].offsetWidth,height:this.$element[0].offsetHeight})},getTitle:function(){var a=
...
this.type).removeData(this.type)}};c.fn.tooltip=function(a){return this.each(function(){var b=c(this),d=b.data("tooltip"),h="object"==typeof a&&a;d||b.data("tooltip",d=new e(this,h));if("string"==typeof a)d[a]()})};c.fn.tooltip.Constructor=e;c.fn.tooltip.defaults={animation:!0,placement:"top",selector:!1,template:'<div class="bt_tooltip"><div class="bt_tooltip-arrow"></div><div class="bt_tooltip-inner"></div></div>',trigger:"hover",title:"",delay:0,html:!0}}(window.jQuery);
